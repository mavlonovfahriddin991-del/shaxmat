...
# 1. Timer state - add after let currentGameId = null;
old1 = "let currentGameId = null;\n\nlet ws = null;"
new1 = "let currentGameId = null;\n\n/* Timer */\nlet myTime = 600;\nlet opponentTime = 600;\nlet timerInterval = null;\n\nlet ws = null;"
d = d.replace(old1, new1)

# 2. Timer + name element refs after chat element refs
old2 = 'const chatBox = document.getElementById("chatBox");\nconst chatInput = document.getElementById("chatInput");\nconst chatSendBtn = document.getElementById("chatSendBtn");\nconst chatMessages = document.getElementById("chatMessages");'
...
# 3. Update enterGame - add timer init
old3 = 'function enterGame(){\n  selected = null;\n  showScreen("screen-game");\n  if(chatBox) chatBox.classList.add("active");\n  buildCoords();\n  drawBoard();\n  updateHeader();\n}'
new3 = old3.replace('showScreen("screen-game");', 'showScreen("screen-game");\n  myTime = 600;\n  opponentTime = 600;\n  updateTimers();\n  startTimer();')
d = d.replace(old3, new3)

# 4. Add startTimer/stopTimer/updateTimers/formatTime before buildCoords
old4 = 'function buildCoords(){'
new4 = '''function startTimer(){
...
# 5. Update updateHeader to use new element IDs
old5 = '''function updateHeader(){
...
# 6. Add updateTimers() call in attemptMove after updateHeader
old6 = '    drawBoard();\n    updateHeader();\n    if(mode === "ai"){ setTimeout(aiMove, 350); }'
new6 = '    drawBoard();\n    updateHeader();\n    updateTimers();\n    if(mode === "ai"){ setTimeout(aiMove, 350); }'
d = d.replace(old6, new6)

# 7. Add stopTimer to leaveGame
old7 = 'leaveGameBtn.addEventListener("click", () => {\n  stopGamePoll();\n  if(chatBox) chatBox.classList.remove("active");'
new7 = 'leaveGameBtn.addEventListener("click", () => {\n  stopTimer();\n  stopGamePoll();\n  if(chatBox) chatBox.classList.remove("active");'
d = d.replace(old7, new7)

# 8. Add updateTimers to gameUpdate case
old8 = '    case "gameUpdate":\n      if(currentGameId === msg.gameId){\n        pieces = msg.pieces;\n        turn = msg.turn;\n        drawBoard();\n        updateHeader();\n      }'
new8 = '    case "gameUpdate":\n      if(currentGameId === msg.gameId){\n        pieces = msg.pieces;\n        turn = msg.turn;\n        drawBoard();\n        updateHeader();\n        updateTimers();\n      }'
d = d.replace(old8, new8)

with open(SRC + "/app.js", "w", encoding="utf-8") as f:
    f.write(d)

print("app.js patched:", len(d), "chars")
print("Syntax", "OK" if d.count("(") == d.count(")") else "PAREN MISMATCH!")
